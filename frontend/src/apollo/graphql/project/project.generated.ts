 ...
 * });
 */
export function useGetMyProjectQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetMyProjectQuery,
    GetMyProjectQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetMyProjectQuery, GetMyProjectQueryVariables>(
    GetMyProjectDocument,
    options
  );
}
export function useGetMyProjectLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetMyProjectQuery,
    GetMyProjectQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetMyProjectQuery, GetMyProjectQueryVariables>(
    GetMyProjectDocument,
    options
  );
}
export type GetMyProjectQueryHookResult = ReturnType<
  typeof useGetMyProjectQuery
>;
export type GetMyProjectLazyQueryHookResult = ReturnType<
  typeof useGetMyProjectLazyQuery
>;
export type GetMyProjectQueryResult = Apollo.QueryResult<
  GetMyProjectQuery,
  GetMyProjectQueryVariables
>;
...
`;
export type ProjectUpdateMutationFn = Apollo.MutationFunction<
...
export function useProjectUpdateMutation(
  ...
  return Apollo.useMutation<
    ProjectUpdateMutation,
    ProjectUpdateMutationVariables
  >(ProjectUpdateDocument, options);
}
export type ProjectUpdateMutationHookResult = ReturnType<
  typeof useProjectUpdateMutation
>;
export type ProjectUpdateMutationResult =
  Apollo.MutationResult<ProjectUpdateMutation>;
export type ProjectUpdateMutationOptions = Apollo.BaseMutationOptions<
  ProjectUpdateMutation,
  ProjectUpdateMutationVariables
>;
